...
def disconnect_node3():
    ...
    subprocess.run(
        ["docker", "network", "disconnect", NETWORK_NAME, CONTAINER_NODE3],
        capture_output=True,
    )
...
def reconnect_node3():
    ...
    subprocess.run(
        ["docker", "network", "connect", NETWORK_NAME, CONTAINER_NODE3],
        capture_output=True,
    )
